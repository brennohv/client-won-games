...
respective owners.
  ...
  return {
    props: {
      ...
      gameInfo: {
        title: 'Borderlands 3',
        description: `Experience the epic space strategy games that redefined the RTS genre. Control your fleet and build an armada
                      across more than 30 single-player missions.`,
        price: '215,00'
      },
      gallery: GalleryMock,
